...
var responses = {
    'favorites':{
        ...
        'food': [
            'My favorite food is rockfish, of course.',
            'I love rock candy for dessert.',
            'Rock Road ice-cream is my favorite.',
            'I do love a good dirt cupcake.',
            "I don't each much, but when I do it's very gneiss.",
            "Cake, but only if it has nice layers"
        ]
    },
    random: [
        "I think you rock!",
